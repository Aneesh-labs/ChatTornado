...
const RightPanelContent = React.memo(({ user, messages, tab, setTab, totalMessagesCount, mediaMessages, theme }) => (
...
const RightPanel = React.memo(({ user = {}, messages = [], isOpen = false, onClose }) => {
